...
use crate::controllers::consortia_controller::{get_all_consortia_controller, post_new_consortium_controller, add_participant_to_consortium_controller, get_consortium_participants_controller, get_consortium_by_user_id_controller, delete_consortium_controller, contemplate_consortium_controller};
...
fn configure_app(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/consortia")
            ...
            .service(add_participant_to_consortium_controller)
